...
#Demo code for Figure 1 of Idesis (2022):
...
# Approach:
# 1) a = take away all nans
# 2) b = replace 2 or less nans with mean
# 3) c = replace all nans with zeroes
...
if researcher == 1:
    if approach == 1:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_0a.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_1a.txt',delimiter=',')
    elif approach == 2:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_chiara_0b.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_chiara_1b.txt',delimiter=',')
    elif approach == 3:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_0c.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_1c.txt',delimiter=',')
elif researcher == 2:
    if approach == 1:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_0a.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_1a.txt',delimiter=',')
    elif approach == 2:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_0b.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_1b.txt',delimiter=',')
    elif approach == 3:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_seba_0c.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_seba_1c.txt',delimiter=',')
elif researcher ==3:
    if approach == 1:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_corbetta_0a.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_corbetta_1a.txt',delimiter=',')
    elif approach == 2:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_corbetta_0b.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_corbetta_1b.txt',delimiter=',')
    elif approach == 3:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_corbetta_0c.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_corbetta_1c.txt',delimiter=',')
elif researcher == 4:
    if approach == 1:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_0a.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_seba_1a.txt',delimiter=',')
    elif approach == 2:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_ec_wo_mask_0b.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/Comparing apporaches txt/severity_ec_wo_mask_1b.txt',delimiter=',')
    elif approach == 3:
        set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_seba_0c.txt',delimiter=',')
        set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_seba_1c.txt',delimiter=',')
...
CLF1 = []
CLFS = []            
for jj in range(0,1000): # Originally it was 1000, CHANGE BACK!!!!!    
    n_estimators = 1000 # cantidad de arboles, Originally it was 1000, CHANGE BACK!!!!! 
    ...
    #set1=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_0_with_nan.txt',delimiter=',')
    #set2=genfromtxt('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/severity_chiara_1_with_nan.txt',delimiter=',')
...
np.savetxt('trust_ec_wo_mask.txt',trust)
np.savetxt('trustS_ec_wo_mask.txt',trustS)
np.savetxt('cm_ec_wo_mask.txt',cm)
np.savetxt('cmS_ec_wo_mask.txt',cmS)

#Registrar el mean de trust y trustS   el AUC promedio del clasificador

auc_promedio = np.sum(trust>trustS)/1000
print(auc_promedio)

cm_accu = cm[0][0];
print(cm_accu)

trust_promedio = np.mean(trust)
print(trust_promedio)
...
#pickle.dump(guardar,  open('C:/Seba/Barcelona/PhD_material/Paper_effective_predictor/Scripts and Results/d_Severitity_classification/clasificador_sc_alone.p', 'wb') )
